...
namespace ABANKandBBANK.CustomersUI.BBANKBilgilerim
{
    public partial class Customer1 : System.Web.UI.Page
    {
        ...
        protected void bilgilerim()
        {
            ...
            var request = httpClient.GetAsync("https://localhost:44340/api/BBANKCustomer1/BBANKGetAllCustomer1").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<List<BBANKCustomer1>>(response);

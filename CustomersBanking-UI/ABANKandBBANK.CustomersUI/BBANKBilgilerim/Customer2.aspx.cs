...
namespace ABANKandBBANK.CustomersUI.BBANKBilgilerim
{
    public partial class Customer2 : System.Web.UI.Page
    {
        ...
        protected void bilgilerim()
        {
            ...
            var request = httpClient.GetAsync("https://localhost:44340/api/BBANKCustomer2/BBANKGetAllCustomer2").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<List<BBANKCustomer2>>(response);
        ...
        {
            Response.Redirect("~/BBANKAnaSayfa/Customer2AnaSayfa.aspx");
        }
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer1.aspx.cs" Inherits="ABANKandBBANK.CustomersUI.BBANKBilgilerim.Customer1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bilgilerim Customer1</title>
...
<body style="background-color: #808080">
    <form id="form1" runat="server">
        ...
        <div class="container" style="width: 1000px; height: 400px; background-color: #0094ff; border-radius: 20px; margin-top: 75px;">
            <br />
            <br />
            <h3 style="color: black; font-weight: bold">BBANK'a Hoşgeldiniz... </h3>
            <br />
            <%: DateTime.Now %>
            <br />

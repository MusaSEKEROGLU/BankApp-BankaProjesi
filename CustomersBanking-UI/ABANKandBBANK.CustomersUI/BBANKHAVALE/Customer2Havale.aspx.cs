...
namespace ABANKandBBANK.CustomersUI.BBANKHAVALE
{
    public partial class Customer2Havale : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var request1 = httpClient1.GetAsync("https://localhost:44340/api/BBANKCustomer2/BBANKGetAllCustomer2").Result;
            var response1 = request1.Content.ReadAsStringAsync().Result;
            var value1 = JsonConvert.DeserializeObject<List<BBANKCustomer2>>(response1);

            var httpClient2 = new HttpClient();
            var request2 = httpClient2.GetAsync("https://localhost:44340/api/BBANKCustomer1Account/BBANKGetAllCustomer1Account").Result;
            var response2 = request2.Content.ReadAsStringAsync().Result;
            var value2 = JsonConvert.DeserializeObject<List<BBANKCustomer1Account>>(response2);

            var httpClient3 = new HttpClient();
            var request3 = httpClient3.GetAsync("https://localhost:44340/api/BBANKCustomer1/BBANKGetAllCustomer1").Result;
            var response3 = request3.Content.ReadAsStringAsync().Result;
            var value3 = JsonConvert.DeserializeObject<List<BBANKCustomer1>>(response3);
        ...
        {   //ABANKHata
            var httpClient = new HttpClient();
            var request = httpClient.GetAsync("https://localhost:44340/api/BBANKCustomer2Account/1").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<ABANKCustomer1Account>(response);

            var httpClient2 = new HttpClient();
            var request2 = httpClient2.GetAsync("https://localhost:44340/api/BBANKCustomer2Account/2").Result;
            var response2 = request2.Content.ReadAsStringAsync().Result;

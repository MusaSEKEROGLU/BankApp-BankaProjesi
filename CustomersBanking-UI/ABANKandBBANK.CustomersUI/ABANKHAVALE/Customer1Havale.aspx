<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer1Havale.aspx.cs" Inherits="ABANKandBBANK.CustomersUI.ABANKHAVALE.Customer1Havale" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ABANK Customer1Havale</title>
    ...
    <form id="form" runat="server">
        <div class="navbar navbar-inverse navbar-fixed-top" style="position: fixed; top: 0px; left: 0px; right: 0px;">
            ...
            <div style="margin-left: 1200px; height: 25px">
                <a class="btn btn-warning " runat="server" href="~/ABANKAnaSayfa/Customer1AnaSayfa.aspx">Ana Sayfa</a>
            </div>
        </div>
        <br />
        <%--ikinci navbar div--%>
        ...
        <div class="container-fluid col-lg-9" id="Tablo" style="height: 1100px;">
            <div class="row">
                <div class="col-sm">
                    <h4 style="color: black; font-family: 'Times New Roman', Times, serif; font-size: large; font-weight: bold;">ABANK HAVALE İşlemleri</h4>

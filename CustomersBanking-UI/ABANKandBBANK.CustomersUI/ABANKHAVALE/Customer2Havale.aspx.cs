...
{
    public partial class Customer2Havale : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Otamatik olarak HesapNo'dan ve IbanNo'dan İsim Getirme Customer1
            var httpClient = new HttpClient();
            var request = httpClient.GetAsync("https://localhost:44340/api/ABANKCustomer2Account/ABANKGetAllCustomer2Account").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<List<ABANKCustomer2Account>>(response);

            var httpClient1 = new HttpClient();
            var request1 = httpClient1.GetAsync("https://localhost:44340/api/ABANKCustomer2/ABANKGetAllCustomer2").Result;
            var response1 = request1.Content.ReadAsStringAsync().Result;
            var value1 = JsonConvert.DeserializeObject<List<ABANKCustomer2>>(response1);

            var httpClient2 = new HttpClient();
            var request2 = httpClient2.GetAsync("https://localhost:44340/api/ABANKCustomer1Account/GetAllCustomer1Account").Result;
            var response2 = request2.Content.ReadAsStringAsync().Result;
            var value2 = JsonConvert.DeserializeObject<List<ABANKCustomer1Account>>(response2);

            var httpClient3 = new HttpClient();
            var request3 = httpClient3.GetAsync("https://localhost:44340/api/ABANKCustomer1/ABANKGetAllCustomer1").Result;
            var response3 = request3.Content.ReadAsStringAsync().Result;
            var value3 = JsonConvert.DeserializeObject<List<ABANKCustomer1>>(response3);
        ...
        protected void btnTemizle_Click(object sender, EventArgs e)
        {
            ...
            if (lblHDrpSecimi.Text == "HAVALE Türü Seçiniz")
            {
        ...
        {   //ABANKHata
            var httpClient = new HttpClient();
            var request = httpClient.GetAsync("https://localhost:44340/api/ABANKCustomer2Account/1").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<ABANKCustomer1Account>(response);

            var httpClient2 = new HttpClient();
            var request2 = httpClient2.GetAsync("https://localhost:44340/api/ABANKCustomer2Account/2").Result;
            var response2 = request2.Content.ReadAsStringAsync().Result;

...
namespace ABANKandBBANK.CustomersUI.ABANKBilgilerim
{
    public partial class Customer2 : System.Web.UI.Page
    {
        ...
        protected void bilgilerim()
        {
            ...
            var request = httpClient.GetAsync("https://localhost:44340/api/ABANKCustomer2/ABANKGetAllCustomer2").Result;
            var response = request.Content.ReadAsStringAsync().Result;
            var value = JsonConvert.DeserializeObject<List<ABANKCustomer2>>(response);

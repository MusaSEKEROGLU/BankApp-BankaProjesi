...
{
    public partial class Customer2EFT : System.Web.UI.Page
    {
        ...
        {  //ABANKHata
            ...
            var value = JsonConvert.DeserializeObject<ABANKCustomer2Account>(response);
            ...
            var value2 = JsonConvert.DeserializeObject<ABANKCustomer2Account>(response2);
            ...
            {
                lblAciklama.Text = "*Açıklama Kısmı Boş Geçilemez!";
            }

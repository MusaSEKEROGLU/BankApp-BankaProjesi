<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer2EFT.aspx.cs" Inherits="ABANKandBBANK.CustomersUI.ABANKEFT.Customer2EFT" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ABANK Customer2EFT</title>
    ...
    <form id="form1" runat="server">
        <div class="navbar navbar-inverse navbar-fixed-top" style="position: fixed; top: 0px; left: 0px; right: 0px;">
            ...
            <div style="margin-left: 1200px; height: 25px">
                <a class="btn btn-warning " runat="server" href="~/ABANKAnaSayfa/Customer2AnaSayfa.aspx">Ana Sayfa</a>
            </div>
        </div>
        <br />
        <%--ikinci navbar div--%>
        ...
        <div class="container-fluid col-lg-8" id="Tablo" style="height: 1100px;">
            <div class="row">
                <div class="col-sm">
                    <h4 style="color: black; font-family: 'Times New Roman', Times, serif; font-size: large; font-weight: bold;">ABANK EFT İşlemleri</h4>
                    ...
                    <div style="width: 300px; height: 750px; background-color: #ffffff; border-radius: 10px; border: 2px solid">
                        <div style="margin-left: 15px; margin-top: 15px">
                            ...
                            <div>
                                ...
                                <div>
                                    <asp:Label ID="lblAciklama" ForeColor="Red" Font-Bold="true" runat="server" Text=""></asp:Label>
                                </div>
                                <br />

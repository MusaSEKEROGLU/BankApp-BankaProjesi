<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer1HesapListesi.aspx.cs" Inherits="ABANKandBBANK.CustomersUI.BBANKHesapListesi.Customer1HesapListesi" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BBANK Customer1HesapListesi</title>
    ...
    <form id="form1" runat="server">
        <div class="navbar navbar-inverse navbar-fixed-top" style="position: fixed; top: 0px; left: 0px; right: 0px;">
            ...
            <div style="margin-left: 1200px; height: 25px">
                <a class="btn btn-warning " runat="server" href="~/BBANKAnaSayfa/Customer1AnaSayfa">Ana Sayfa</a>
            </div>
        </div>
        <div class="container-fluid" id="Tablo" style="width: 1600px; height: 750px; border-radius: 10px; margin-left: 10px; margin-top: 75px; background-color: #0094ff; opacity: 1.2; overflow-x: auto; overflow-y: auto;">
            ...
            <div>
                ...
                <div style="height: 350px; width: 1564px; overflow: scroll">
                    <asp:GridView ID="GrdHesapHareketleri" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Height="84px" Width="1539px" OnRowCreated="GrdHesapHareketleri_RowCreated" ForeColor="Black" GridLines="Vertical">

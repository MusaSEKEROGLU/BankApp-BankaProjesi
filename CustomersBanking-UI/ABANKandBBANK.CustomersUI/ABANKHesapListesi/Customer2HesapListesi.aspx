<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer2HesapListesi.aspx.cs" Inherits="ABANKandBBANK.CustomersUI.ABANKHesapListesi.Customer2HesapListesi" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ABANK Customer2HesapListesi</title>
    ...
    <form id="form1" runat="server">
        <div class="navbar navbar-inverse navbar-fixed-top" style="position: fixed; top: 0px; left: 0px; right: 0px;">
            ...
            <div style="margin-left: 1200px; height: 25px">
                <a class="btn btn-warning " runat="server" href="~/ABANKAnaSayfa/Customer2AnaSayfa">Ana Sayfa</a>
            </div>
        </div>
        <div class="container-fluid" id="Tablo" style="width: 1600px; height: 750px; border-radius: 10px; margin-left: 10px; margin-top: 75px; background-color: #0094ff; opacity: 1.2; overflow-x: auto; overflow-y: auto;">
            <h4 style="color: #ffffff; font-family: 'Times New Roman', Times, serif; font-size: large; font-weight: bold;">ABANK Hesaplarım</h4>
            ...
            <div>
                ...
                <div style="height: 350px; width: 1546px; overflow: scroll">
                    <asp:GridView ID="GrdHesapHareketleri" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Height="87px" Width="1522px" OnRowCreated="GrdHesapHareketleri_RowCreated" ForeColor="Black" GridLines="Vertical">

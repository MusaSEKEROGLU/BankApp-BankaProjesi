...
{
    public class BBANKCustomer1Account1DetailsConfiguration : IEntityTypeConfiguration<BBANKCustomer1Account1Details>
    {
        public void Configure(EntityTypeBuilder<BBANKCustomer1Account1Details> builder)
        {
            ...
            builder.ToTable("BBANKCustomer1Account1Details");
        }
    }
}

...
{
    public class BBANKCustomer1Account1ActivitiesConfiguration : IEntityTypeConfiguration<BBANKCustomer1Account1Activities>
    {
        public void Configure(EntityTypeBuilder<BBANKCustomer1Account1Activities> builder)
        {
            ...
            builder.ToTable("BBANKCustomer1Account1Activities");

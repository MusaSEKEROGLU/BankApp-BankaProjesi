...
{
    public class BBANKCustomer2Account1ActivitiesConfiguration : IEntityTypeConfiguration<BBANKCustomer2Account1Activities>
    {
        public void Configure(EntityTypeBuilder<BBANKCustomer2Account1Activities> builder)
        {
            ...
            builder.ToTable("BBANKCustomer2Account1Activities");

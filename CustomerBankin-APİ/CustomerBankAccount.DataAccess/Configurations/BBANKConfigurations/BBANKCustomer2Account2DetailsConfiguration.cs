...
{
    public class BBANKCustomer2Account2DetailsConfiguration : IEntityTypeConfiguration<BBANKCustomer2Account2Details>
    {
        public void Configure(EntityTypeBuilder<BBANKCustomer2Account2Details> builder)
        {
            ...
            builder.ToTable("BBANKCustomer2Account2Details");

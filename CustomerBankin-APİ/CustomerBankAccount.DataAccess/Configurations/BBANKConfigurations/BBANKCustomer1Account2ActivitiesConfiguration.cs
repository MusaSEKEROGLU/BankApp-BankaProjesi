...
{
    public class BBANKCustomer1Account2ActivitiesConfiguration : IEntityTypeConfiguration<BBANKCustomer1Account2Activities>
    {
        public void Configure(EntityTypeBuilder<BBANKCustomer1Account2Activities> builder)
        {
            ...
            builder.ToTable("BBANKCustomer1Account2Activities");

...
{
    public class ABANKCustomer2Account2ActivitiesConfiguration : IEntityTypeConfiguration<ABANKCustomer2Account2Activities>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer2Account2Activities> builder)
        {
            ...
            builder.ToTable("ABANKCustomer2Account2Activities");

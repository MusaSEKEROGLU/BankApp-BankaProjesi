...
{
    public class ABANKCustomer1Account1DetailsConfiguration : IEntityTypeConfiguration<ABANKCustomer1Account1Details>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer1Account1Details> builder)
        {
            ...
            builder.ToTable("ABANKCustomer1Account1Details");

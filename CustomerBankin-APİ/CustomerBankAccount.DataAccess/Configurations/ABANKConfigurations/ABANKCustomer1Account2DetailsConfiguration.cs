...
{
    public class ABANKCustomer1Account2DetailsConfiguration : IEntityTypeConfiguration<ABANKCustomer1Account2Details>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer1Account2Details> builder)
        {
            ...
            builder.ToTable("ABANKCustomer1Account2Details");

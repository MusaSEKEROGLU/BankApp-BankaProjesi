...
{
    public class ABANKCustomer2Account1DetailsConfiguration : IEntityTypeConfiguration<ABANKCustomer2Account1Details>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer2Account1Details> builder)
        {
            ...
            builder.ToTable("ABANKCustomer2Account1Details");

...
{
    public class ABANKCustomer2Account1ActivitiesConfiguration : IEntityTypeConfiguration<ABANKCustomer2Account1Activities>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer2Account1Activities> builder)
        {
            ...
            builder.ToTable("ABANKCustomer2Account1Activities");

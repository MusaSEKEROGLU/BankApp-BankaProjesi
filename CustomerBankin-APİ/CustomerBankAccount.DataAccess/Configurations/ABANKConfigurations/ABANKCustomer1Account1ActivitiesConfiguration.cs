...
{
    public class ABANKCustomer1Account1ActivitiesConfiguration : IEntityTypeConfiguration<ABANKCustomer1Account1Activities>
    {
        public void Configure(EntityTypeBuilder<ABANKCustomer1Account1Activities> builder)
        {
            ...
            builder.ToTable("ABANKCustomer1Account1Activities");

...
{
    public class ABANKCustomer2Account2DetailsRepository : ABANKICustomer2Account2DetailsRepository
    {
        ABANKCustomer2Account2Details customer2Account2Details = new ABANKCustomer2Account2Details();

        public void DeleteCustomer2Account2Details(int id)
        {
            SqlCommand cmd = new SqlCommand("sp_ABANKCustomer2Account2Details_Delete", CBADbContext.Baglanti);
        ...
        {
            SqlDataAdapter adapter = new SqlDataAdapter("sp_ABANKCustomer2Account2Details_Select", CBADbContext.Baglanti);
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            DataTable dt = new DataTable();
            adapter.Fill(dt);
            List<ABANKCustomer2Account2Details> listcustomer2Account2Details = new List<ABANKCustomer2Account2Details>();
            if (dt.Rows.Count > 0)
            {
        ...
        {
            SqlDataAdapter adapter = new SqlDataAdapter("sp_ABANKCustomer2Account2DetailsById_Select", CBADbContext.Baglanti);
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            if (aBANKCustomer2Account2Details == null)
            {
                SqlCommand cmd = new SqlCommand("sp_ABANKCustomer2Account2Details_Select", CBADbContext.Baglanti);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@SubeKodu", aBANKCustomer2Account2Details.SubeKodu);
                cmd.Parameters.AddWithValue("@HesapNo", aBANKCustomer2Account2Details.HesapNo);
                cmd.Parameters.AddWithValue("@HesapAdi", aBANKCustomer2Account2Details.HesapAdi);
                cmd.Parameters.AddWithValue("@IbanNo", aBANKCustomer2Account2Details.IbanNo);
                cmd.Parameters.AddWithValue("@HesapBakiye", aBANKCustomer2Account2Details.HesapBakiye);
                cmd.Parameters.AddWithValue("@GünlükTransferLimiti", aBANKCustomer2Account2Details.GünlükTransferLimiti);
                cmd.Parameters.AddWithValue("@SubeAdi", aBANKCustomer2Account2Details.SubeAdi);
                cmd.Parameters.AddWithValue("@MusteriNo", aBANKCustomer2Account2Details.MusteriNo);
                cmd.Parameters.AddWithValue("@HesapAktifMi", aBANKCustomer2Account2Details.HesapAktifMi);
                CBADbContext.Baglanti.Open();
                int i = cmd.ExecuteNonQuery();
                CBADbContext.Baglanti.Close();
            }
            return aBANKCustomer2Account2Details;
        }
        public ABANKCustomer2Account2Details PutCustomer2Account2Details(ABANKCustomer2Account2Details aBANKCustomer2Account2Details)
        {
            if (aBANKCustomer2Account2Details == null)
            {
                SqlCommand cmd = new SqlCommand("sp_ABANKCustomer2Account2Details_Update", CBADbContext.Baglanti);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@SubeKodu", aBANKCustomer2Account2Details.SubeKodu);
                cmd.Parameters.AddWithValue("@HesapNo", aBANKCustomer2Account2Details.HesapNo);
                cmd.Parameters.AddWithValue("@HesapAdi", aBANKCustomer2Account2Details.HesapAdi);

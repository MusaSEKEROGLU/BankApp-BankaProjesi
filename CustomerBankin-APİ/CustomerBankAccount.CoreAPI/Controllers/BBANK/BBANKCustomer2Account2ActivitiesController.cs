...
namespace CustomerBankAccount.CoreAPI.Controllers.BBANK
{
    ...
    [ApiController]
    //[Authorize]
    public class BBANKCustomer2Account2ActivitiesController : ControllerBase
    {
        private BBANKICustomer2Account2ActivitiesService customer2Account2ActivitiesSAervice;
        private readonly IDataProtector dataProtector;
        public BBANKCustomer2Account2ActivitiesController(BBANKICustomer2Account2ActivitiesService customer2Account2ActivitiesSAervice, IDataProtectionProvider provider)
        {
        ...
        private List<BBANKCustomer2Account2Activities> Customer2Account2Activities()
        {
            var customer2Account2 = new List<BBANKCustomer2Account2Activities>();
            customer2Account2.Add(new BBANKCustomer2Account2Activities()
            {
        ...
        [HttpGet("BBANKGetAllCustomer2Account2Activities")]
